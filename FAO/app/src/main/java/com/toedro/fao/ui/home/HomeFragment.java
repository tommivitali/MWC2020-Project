...
public class HomeFragment extends Fragment {
    ...
    private MaterialButton buttonStartStop, StartStop;
    ...
    private com.toedro.fao.stepcounter.StepCounterListener listener;
...
// Button to go scanning barcode
        ...
        kindOfCountTextView.setText(pth == ProgressTypeHome.KCAL ?
...
//  Get an instance of the sensor manager
        ...
        listener = com.toedro.fao.stepcounter.StepCounterListener.getInstance(stepsCompleted, stepsCountTextView, pth);
