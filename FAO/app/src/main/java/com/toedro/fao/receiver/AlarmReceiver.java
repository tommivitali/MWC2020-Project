...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    private void deliverNotification(Context context) {
        ...
        NotificationCompat.Builder builder = getNotificationBuilder(context, MainActivity.getPrimaryChannelId());
        mNotificationManager.notify(MainActivity.getNotificationId(), builder.build());
    }

    private NotificationCompat.Builder getNotificationBuilder(Context context, String PRIMARY_CHANNEL){
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(context, PRIMARY_CHANNEL)
                .setContentTitle("Your recipe is ready!")
                .setContentText("This is your notification text. TOCHANGE")
                .setSmallIcon(R.drawable.ic_menu_recipes).setColor(Color.YELLOW)
                .setPriority(NotificationCompat.PRIORITY_HIGH)
                .setAutoCancel(true).setDefaults(NotificationCompat.DEFAULT_ALL); //TODO change icon and text
